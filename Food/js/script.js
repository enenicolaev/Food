...
// Calc
function calc() {
  var weight, height, age, sex, ratio, resultCalc;

  function initLocalStorageSettings(selector, activeClass) {
    var elements = document.querySelectorAll(selector);
    elements.forEach(function (elem) {
      elem.classList.remove(activeClass); // id for sex param
...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    ...
    return MenuCard;
  }(); // ФУНКЦИЯ GET ПОЛУЧЕНИЯ ДАННЫХ О КАРТОЧКЕ


  var getCardInfo = /*#__PURE__*/function () {
    ...
    return function getCardInfo(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  getCardInfo("http://localhost:25000/menu").then(function (data) {
...
function forms(formSelector) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      postData("http://localhost:25000/requests", json).then(function (response) {
  ...
  function showThanksModal(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_10__["openModal"])(".modal");
...
function slider(_ref) {
  var wrapperSelector = _ref.wrapperSelector,
      fieldSelector = _ref.fieldSelector,
      prevArrowSelector = _ref.prevArrowSelector,
      nextArrowSelector = _ref.nextArrowSelector,
      slideSelector = _ref.slideSelector,
      currentNumSelector = _ref.currentNumSelector,
      totalNumSelector = _ref.totalNumSelector;
  var slideIndex = 1,
      offset = 0; //Отсуп
  ...
  var slides = document.querySelectorAll(slideSelector),
      ...
      dots = []; // to init it need to delete .offer__slider-inner si,ple slider with display: block; display: none
  ...
  initComplexSwiper(); // slider Nav Pagination
...
function tabs(_ref) {
  var tabSelector = _ref.tabSelector,
      ...
      tabsParentSelector = _ref.tabsParentSelector;
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    Object(_modules_modal__WEBPACK_IMPORTED_MODULE_3__["openModal"])('.modal', modalTimerId);
  }, 300000);
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_3__["default"])(".modal", modalTimerId);
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])("2020-12-31");
});
